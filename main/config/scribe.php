...
return [
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token with api <a href="#auth-POST-user-login">Generate API token</a>.',
    ],
...
//        'javascript',
    ...
    /*
     * Endpoints that don't have a @group will be placed in this default group.
     */
